...
const plans: PricingPlan[] = [
  {
    ...
    price: 'Gratuit',
    priceNote: 'sans limite de temps',
    duration: 'Illimitée',
    features: [
  ...
  return (
    <div className="bg-[#fdfbf7] min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 mb-24">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-serif font-bold text-stone-900 mb-3">Comparateur de prix</h2>
          ...
          <p className="text-stone-600 text-sm max-w-2xl mx-auto mb-6 p-4 bg-teal-50/70 border border-teal-100 rounded-xl">
            <strong className="text-teal-800">En papier</strong> : chaque destinataire = une carte +
            un timbre à payer (donc le coût multiplie par le nombre d&apos;envois).{' '}
            <strong className="text-teal-800">Chez nous</strong> : une seule carte peut être envoyée
            à un nombre illimité de destinataires — vous ne payez qu&apos;une fois par carte.
          </p>
        </div>
          ...
          <table className="w-full min-w-[500px] border-collapse rounded-2xl overflow-hidden border border-stone-200 bg-white shadow-sm">
            <thead>
              <tr className="bg-stone-50 border-b border-stone-200">
                <th className="text-left py-4 px-6 font-bold text-stone-800">
                  Nombre d&apos;envois
                </th>
                ...
                <th className="text-center py-4 px-6 font-bold text-stone-500 text-sm">Économie</th>
              </tr>
            </thead>
            <tbody className="text-stone-700">
              <tr className="border-b border-stone-100">
                ...
                <td className="py-3 px-6 text-center text-green-600 font-semibold">
                  ~30 % / 2,50 €
                </td>
              </tr>
              <tr className="border-b border-stone-100 bg-stone-50/30">
                ...
                <td className="py-3 px-6 text-center font-bold text-teal-600">
                  22 € (pack 10) ou 1 carte réutilisable
                </td>
                <td className="py-3 px-6 text-center text-green-600 font-semibold">
                  ~37 % / 2,50 €
                </td>
              ...
              <tr className="border-b border-stone-100">
                ...
                <td className="py-3 px-6 text-center font-bold text-teal-600">
                  40 € (pack 20) ou 1 carte réutilisable
                </td>
                <td className="py-3 px-6 text-center text-green-600 font-semibold">
                  ~43 % / 2,50 €
                </td>
              ...
              <tr className="border-b border-stone-100 bg-stone-50/30">
                ...
                <td className="py-3 px-6 text-center font-bold text-teal-600">
                  95 € (pack 50) ou 1 carte réutilisable
                </td>
                <td className="py-3 px-6 text-center text-green-600 font-semibold">
                  ~46 % / 2,50 €
                </td>
              ...
              <tr>
                ...
                <td className="py-3 px-6 text-center font-bold text-teal-600">
                  150 € (pack 100) ou 1 carte réutilisable
                </td>
                <td className="py-3 px-6 text-center text-green-600 font-semibold">
                  ~57 % / 2,50 €
                </td>
          ...
          <table className="w-full min-w-[500px] border-collapse rounded-2xl overflow-hidden border border-stone-200 bg-white shadow-sm">
            ...
            <tbody className="text-stone-700">
              ...
              <tr className="border-b border-stone-100 bg-stone-50/30">
                ...
                <td className="py-3 px-6 text-center">
                  <Check className="w-5 h-5 text-green-500 inline" /> Savoir quand la carte est
                  ouverte
                </td>
              </tr>
              <tr className="border-b border-stone-100">
              ...
              <tr className="bg-stone-50/30">
                ...
                <td className="py-3 px-6 text-center">
                  <Check className="w-5 h-5 text-green-500 inline" /> Envoi à la date et
                  l&apos;heure choisies
                </td>
              </tr>
            </tbody>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-sm hover:shadow-md hover:border-teal-200 transition-all">
            ...
            <p className="text-stone-600 text-sm leading-relaxed">
              Envoyez la carte{' '}
              <strong className="text-teal-600">le jour de l’anniversaire à 8h00</strong> pile.
          ...
          <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-sm hover:shadow-md hover:border-teal-200 transition-all">
            ...
            <p className="text-stone-600 text-sm leading-relaxed">
              ...
              Chaque carte peut être envoyée à un{' '}
              <strong className="text-teal-600">nombre illimité de destinataires</strong>. Cartes
              100 % virtuelles, avec statistiques de visite — aucune impression.
            </p>
          </div>
          <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-sm hover:shadow-md hover:border-violet-200 transition-all">
            ...
            <p className="font-bold text-stone-900 mb-2">Carte gratuite</p>
            <p className="text-stone-600 text-sm leading-relaxed">
              Créez sans payer. Votre carte est modifiable via le lien reçu par email — changez
              photo ou texte sans limite de temps, puis prolongez à 2,50 € si vous le souhaitez.
            </p>
          </div>

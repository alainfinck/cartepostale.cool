...
export const metadata: Metadata = {
  ...
  description:
    "Choisissez le plan qui vous correspond. Envoyez des cartes postales à l'unité ou profitez de tarifs réduits avec nos abonnements.",
}
...
const pricingPlans: PricingPlan[] = [
  {
    ...
    notIncluded: ['Multi-photos / collage', 'Haute résolution (HD)', 'Carte vidéo ou audio'],
  ...
  },
  {
    ...
    features: [
      ...
      'Album participatif (invitez vos amis à ajouter des photos)',
    ],
    notIncluded: ['Carte postale vidéo', 'Message vocal / audio', 'Protection par mot de passe'],
  ...
  },
  {
    ...
    notIncluded: ['Volume illimité', 'API / Pro'],
    buttonText: 'Choisir cette option',
    buttonVariant: 'outline',
    href: '/editor',
    popular: false,
    ...
    <div className="bg-[#fdfbf7] min-h-screen py-24 pb-32">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 text-center">
        ...
        <p className="text-xl text-stone-600 max-w-2xl mx-auto leading-relaxed">
          Que vous soyez un voyageur occasionnel ou un grand voyageur, nous avons la formule adaptée
          à vos besoins.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-6 items-stretch">
          {pricingPlans.map((plan, index) => (
            <div
              key={index}
              className={`relative bg-white rounded-2xl shadow-xl border overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 flex flex-col ${
                plan.popular
                  ? 'border-teal-500 ring-4 ring-teal-500/10 z-10 lg:scale-105'
                  : 'border-stone-100'
              }`}
            >
              {plan.popular && (
              ...
              <div className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-3">
                  <div
                    className={`p-2 rounded-lg shrink-0 ${plan.popular ? 'bg-teal-100' : 'bg-stone-100'}`}
                  >
                    {plan.icon}
                  </div>
                  <div>
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    {plan.features.map((feature, i) => (
                      <div key={i} className="flex items-start gap-2">
                        ...
                        <span className="text-stone-700 text-xs font-medium leading-snug">
                          {feature}
                        </span>
                      </div>
                    ))}
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-stone-400 text-lg mb-8 max-w-xl">
                {enterprisePlan.description} Nos experts vous accompagnent pour créer des
                expériences mémorables à grande échelle.
              </p>
            ...
            <div className="flex-shrink-0 bg-stone-800/50 backdrop-blur-sm border border-stone-700/50 rounded-2xl p-8 w-full lg:w-80 text-center">
              <div className="text-stone-400 mb-2 uppercase tracking-widest text-sm font-bold">
                À partir de
              </div>
      ...
      <div className="max-w-3xl mx-auto px-4 mt-24 text-center">
        ...
        <p className="text-stone-600 mb-8">
          Que vous ayez une question technique ou besoin d'un devis personnalisé, nous sommes à
          votre écoute.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/contact"
            className="px-8 py-3 bg-white border border-stone-200 rounded-full font-bold text-stone-700 hover:bg-stone-50 transition-colors"
          >

...
import { LayoutDashboard, Mail, Users, Building2, Image as ImageIcon, Cloud, LogOut, Menu, BarChart3, Sticker, Gift } from 'lucide-react'
...
const nav = [
  ...
  { href: '/manager/codes-promo', label: 'Codes promo', icon: Gift },

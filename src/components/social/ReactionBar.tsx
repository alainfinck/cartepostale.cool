        ...
        return (
          ...
          >
            <motion.button
              ...
              className={`
                                flex items-center justify-center gap-1 sm:gap-1.5 px-2 py-1.5 sm:px-3 sm:py-2 rounded-full border text-xs sm:text-sm
                                transition-all duration-500 ease-out cursor-pointer shadow-sm min-w-max
                                ${
                                  isActive
            ...
            >
              ...
              {count > 0 && (
                <NumberTicker value={count} className="text-xs sm:text-sm font-bold text-inherit" />
              )}
            </motion.button>
          </CoolMode>
        )

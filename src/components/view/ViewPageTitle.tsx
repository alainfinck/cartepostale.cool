...
export default function ViewPageTitle({ title, senderName }: ViewPageTitleProps) {
  ...
  return (
    <div className="text-center mb-12 md:mb-20 px-4 mt-8 md:mt-16 pt-4 md:pt-6 landscape:mb-2 landscape:mt-0 landscape:pt-0 relative z-10 flex flex-col items-center gap-6">
      <TextAnimate
        animation="blurInUp"
        by="word"
        duration={2}

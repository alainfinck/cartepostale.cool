            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-stone-500 text-lg">
                        Redécouvrez le plaisir d&apos;envoyer des cartes postales sans les contraintes habituelles.
                        Moins cher, plus rapide, et surtout beaucoup plus fun.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="bg-stone-50 rounded-3xl p-8 border border-stone-100 relative opacity-80 scale-95 origin-right">
                        ...
                        <h3 className="text-xl font-bold text-stone-600 mb-6 flex items-center gap-2">
                            <span className="w-8 h-8 rounded-full bg-stone-200 flex items-center justify-center text-stone-500 text-sm">VS</span>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3 text-stone-500">
                                ...
                                <div>
                                    <span className="font-semibold block text-stone-600">Payez par carte + timbre</span>
                    ...
                    <div className="bg-white rounded-3xl p-8 md:p-10 border border-pink-100 shadow-xl shadow-pink-100/30 relative z-10 transform md:-translate-x-4">
                        ...
                        <ul className="space-y-6">
                            <li className="flex items-start gap-4">
                                ...
                                <div>
                                    <span className="font-bold block text-stone-800 text-lg">Payez 1x, envoyez à l&apos;infini</span>
                                    <span className="text-stone-500">2€ seulement pour des envois illimités</span>
                                </div>
                            </li>
                            <li className="flex items-start gap-4">
                                <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center shrink-0 mt-0.5">
                            ...
                            <li className="flex items-start gap-4">
                                ...
                                <div>
                                    <span className="font-bold block text-stone-800 text-lg">100% Social & Interactif</span>
                        ...
                        <div className="mt-8 pt-8 border-t border-stone-100">
                            <div className="flex items-center justify-between">
                                <div className="text-center">
                                    ...
                                    <div className="text-3xl font-bold text-stone-300 line-through Decoration-rose-500/50">~35€</div>
                                </div>

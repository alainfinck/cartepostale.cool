    ...
    return (
        <button
            ...
            className={cn(
                ...
                'rounded-full bg-white/50 hover:bg-white/70 text-stone-500 hover:text-teal-600 border border-white/60 shadow-[0_4px_20px_rgba(0,0,0,0.06)] hover:shadow-[0_8px_28px_rgba(0,0,0,0.1)] backdrop-blur-xl',
